...
class Paused(State):
	...
	image = None
	text = ''
	# Has the user ended the pause?
	# Set this to a file name if you want an image
	# Set this to some informative text
	def handle(self, event):
		"""
...
class Info(Paused):
	...
	nextState = Level
	text = '''
	In this game you are Banana,
	trying to survive a course in
	self-defense against a 16ton weight.
        Use the mouse cursor to move the banana'''
